...
for L = 1:length(chr_nums)
    ...
    data_dbf2 = DS.length_underreplication_left(idx_dbf2);
    data_cdc20 = DS.length_underreplication_left(idx_cdc20);
    ...
    data_dbf2 = DS.length_underreplication_right(idx_dbf2);
    data_cdc20 = DS.length_underreplication_right(idx_cdc20);
...
%% y-axis - cdc20; x-axis - dbf2; every dot - length of underreplication
clrs1 = parula(12);
clrs2 = hot(12);
clrs3 = summer(12);
clrs4 = lines(6);
...
%print('-dpsc2' , 'fig__scatter__LengthUnderreplication.eps');
%% legend
